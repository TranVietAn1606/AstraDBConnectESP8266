...
#define TEST_HOST "261f6aad-9ad4-4219-8d26-cb37ead7bd8b-asia-south1.apps.astra.datastax.com"
...
void makeHTTPRequest(String id, String temp, String hum, String amount, String pos) {
  ...
  http.addHeader("X-Cassandra-Token", "AstraCS:bHUqnCcdHGffgjEgQdYUNogf:3ffc39c3240396d034653f40237239f9121cd9645e985d680e7e9af9ee4830ef");
