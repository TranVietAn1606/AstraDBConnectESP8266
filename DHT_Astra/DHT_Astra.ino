...
void loop() {
  ...
  while (1) {
    ...
    //    int hum_i  = random(25);
    float humility_val = dht.readHumidity();
    ...
    makeHTTPRequest(String(id_val), String(temprature_val), String(humility_val), String(amount_of_rain[amount_i]), String(positions[pos_i]));
    id_val++;
  }
}
